...
useSeo({
  ...
  jsonLd: [
    buildBreadcrumbSchema([
      { name: 'Home', href: '/' },
      { name: 'Trasporto Standard', href: '/trasporto-standard' },
    ]),
    buildServiceSchema('Trasporto Standard', 'Servizio di trasporto standard nazionale con rete capillare e pianificazione puntuale.', {
