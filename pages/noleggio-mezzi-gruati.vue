...
useSeo({
  ...
  jsonLd: [
    buildBreadcrumbSchema([
      { name: 'Home', href: '/' },
      { name: 'Noleggio Mezzi Gruati', href: '/noleggio-mezzi-gruati' },
    ]),
    buildServiceSchema('Noleggio Mezzi Gruati', 'Mezzi gruati e supporto operativo per sollevamenti complessi.', {
